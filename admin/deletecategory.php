<?php 
	...
	mysqli_query($db, "DELETE FROM category WHERE categoryID = '$catID'");

	//delete products from category that was deleted
	$query = mysqli_query($db, "SELECT * FROM product");
	mysqli_query($db, "DELETE FROM product WHERE categoryID = '$catID'");
...
<?php include '../view/header.php'; ?>
	...
	<div class="container" style="padding-left: 400px;">
        <div class="panel panel-default" style="width:50%;">
          ...
          <div class="panel-body" style="font-size:18px;"><?php echo $catID; ?></div>
        </div>
    </div>
